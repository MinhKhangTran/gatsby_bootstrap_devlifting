      ...
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to DevLifting.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to DevLifting, accessible from{" "}
              <a
                href="https://devlifting.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://devlifting.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://devlifting/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://devlifting/contact
            </a>
          </li>
        </ul>
      </Container>
